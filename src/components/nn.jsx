      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`flex justify-between h-[100px] items-center`}>
          ...
          <motion.div
            ...
            className="fixed inset-0 bg-primary bg-opacity-95 flex flex-col justify-center items-center z-50"
          >
            {/* Close Button */}
            ...
            {/* Language Toggle and Contact Button for small screens */}
            <div className="flex flex-col items-center space-y-4 mt-4">
              <button
                className={`text-white flex items-center px-4 py-2 
                  rounded-md text-md font-medium transition-colors duration-300 ${language === 'en' ? 'font-en' : 'font-ar'}`}
                onClick={toggleLanguage}
              >
                {language === 'en' ? (
                  <>
